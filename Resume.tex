...
\begin{itemize}
    \item 设计纯 C++ 腿式机器人\textbf{运动学里程计}（多传感器融合），支持 ROS1/ROS2 便捷迁移(\href{https://github.com/ShineMinxing/Ros2Go2Estimator}{\textbf{\underline{GitHub\faStar{}95}}}\;\raisebox{-0.1ex}{\faExternalLink})
    \item 使用 ROS2 \textbf{SLAM Toolbox}、\textbf{Nav2-DWBLocalPlanner} 实现SLAM建图与导航
...
&
\begin{minipage}[t]{\linewidth}\centering
\href{https://www.bilibili.com/video/BV1ytMizEEdG}{\includegraphics[width=0.8\linewidth]{神经网络.jpg}}\\
\href{https://www.bilibili.com/video/BV1ytMizEEdG}{\textbf{多种神经网络位置预测}}
\end{minipage}
\\
